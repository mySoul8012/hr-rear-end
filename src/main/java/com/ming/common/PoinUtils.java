                    ...
                    for (int k = 0; k < physicalNumberOfCells; k++) {
                        ...
                        switch (cell.getCellTypeEnum()) {
                            ...
                            default: {
                                switch (k) {
                                    case 4:
                                        employee.setBirthday(DateToStr(cell.getDateCellValue()));
                                        break;
                                    case 19:
                                        employee.setBeginDate(DateToStr(cell.getDateCellValue()));
                                        break;
                                    case 22:
                                        employee.setContractTerm(cell.getNumericCellValue());
                                        break;
                                    case 23:
                                        employee.setBeginContract(DateToStr(cell.getDateCellValue()));
                                        break;
                                    case 24:
                                        employee.setEndContract(DateToStr(cell.getDateCellValue()));
                                        break;
                                }
                            }
                            break;
